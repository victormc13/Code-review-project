...
**[Code-review-project]** is the project of Microverse, where I will do the role of code reviewer for exercise of Microverse Trial that I done with a partner before to be accepted to Microverse, new GitHub repo it was created, set up linters and make sure github/workflows works properly, with good practices in the most professional way possible.
...
```sh
  cd [your-folder]
  git clone https://github.com/victormc13/Code-review-project.git
```
...
Feel free to check the [issues page](https://github.com/victormc13/Code-review-project/issues).
